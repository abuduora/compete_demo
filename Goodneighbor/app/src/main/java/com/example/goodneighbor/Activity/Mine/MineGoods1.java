...
import com.example.goodneighbor.Activity.Share.ShareQrView;
...
public class MineGoods1 extends AppCompatActivity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        Button share_test1=findViewById(R.id.share_test1);

        share_test1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i=new Intent(getApplicationContext(), ShareQrView.class);
                startActivity(i);
            }
        });
