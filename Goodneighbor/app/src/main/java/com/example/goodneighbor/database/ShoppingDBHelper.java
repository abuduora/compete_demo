...
public class ShoppingDBHelper extends SQLiteOpenHelper {
    ...
    private ShoppingDBHelper(Context context){super(context,DB_NAME,null,DB_VERSION);}
    ...
    public void insertCartInfo(int goodsId) {
        //如果购物车中不存在该商品，添加一条信息
        CartInfo cartInfo=queryCarInfoByGoodsId(goodsId);
        ContentValues values=new ContentValues();
    ...
    //根据商品信息ID查询购物车信息
    private CartInfo queryCarInfoByGoodsId(int goodsId) {
