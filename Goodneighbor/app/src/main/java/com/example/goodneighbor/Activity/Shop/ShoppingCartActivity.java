...
import com.example.goodneighbor.util.CartInfo;
...
public class ShoppingCartActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_shopping_channel).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // 从购物车页面跳到商场页面
                Intent intent = new Intent(ShoppingCartActivity.this, ShopFragment.class);
                intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);//避免重复跳转
        ...
        findViewById(R.id.btn_clear).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // 显示最新的商品数量
                showCount();
                ToastUtil.show(ShoppingCartActivity.this, "购物车已清空");
            }
        });
        findViewById(R.id.btn_settle).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // 点击了“结算”按钮
